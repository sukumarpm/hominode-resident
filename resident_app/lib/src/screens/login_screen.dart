...
class _LoginScreenState extends State<LoginScreen>
  ...
  /// Handle Email/Password Login - Validates resident access
  Future<void> _handleEmailLogin() async {
    try {
      print('🔵 _handleEmailLogin: Starting resident login...');
      ...
      if (!isPhone && !_residentLoginService.validateEmail(identifier)) {
      ...
      // Perform resident login with validation
      print('🔐 Calling ResidentLoginService.loginAsResident...');
      final result = await _residentLoginService.loginAsResident(
      ...
      if (result.success) {
        ...
        print('   Flat: ${result.flatId}');
        print('   Building: ${result.buildingId}');
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            if (email.isEmpty || !_residentLoginService.validateEmail(email)) {
